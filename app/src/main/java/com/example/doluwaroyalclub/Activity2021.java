...
public class Activity2021 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_2021);
    ...
    private void fetchUserData() {
        ...
        usersRef.child(userId).child("yearlyData").child("2021").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(Activity2021.this, "No data found for 2018", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Activity2021.this, "Failed to load data", Toast.LENGTH_SHORT).show();
            }
        });
    }
