...
public class Activity2027 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_2027);
    ...
    private void fetchUserData() {
        ...
        usersRef.child(userId).child("yearlyData").child("2027").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
