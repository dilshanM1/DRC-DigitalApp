...
public class Activity2030 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_2030);
    ...
    private void fetchUserData() {
        ...
        usersRef.child(userId).child("yearlyData").child("2030").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
