...
public class Activity2026 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_2026);
    ...
    private void fetchUserData() {
        ...
        usersRef.child(userId).child("yearlyData").child("2026").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
