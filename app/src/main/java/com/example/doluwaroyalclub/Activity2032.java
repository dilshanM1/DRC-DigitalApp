...
public class Activity2032 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_2032);
    ...
    private void fetchUserData() {
        ...
        usersRef.child(userId).child("yearlyData").child("2032").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
