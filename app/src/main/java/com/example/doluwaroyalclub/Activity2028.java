...
public class Activity2028 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_2028);
    ...
    private void fetchUserData() {
        ...
        usersRef.child(userId).child("yearlyData").child("2028").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
