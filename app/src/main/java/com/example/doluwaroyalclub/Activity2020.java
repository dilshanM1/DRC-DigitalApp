...
public class Activity2020 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_2020);
    ...
    private void fetchUserData() {
        ...
        usersRef.child(userId).child("yearlyData").child("2020").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(Activity2020.this, "No data found for 2018", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Activity2020.this, "Failed to load data", Toast.LENGTH_SHORT).show();
            }
        });
    }
