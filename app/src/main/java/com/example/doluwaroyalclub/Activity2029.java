...
public class Activity2029 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_2029);
    ...
    private void fetchUserData() {
        ...
        usersRef.child(userId).child("yearlyData").child("2029").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
